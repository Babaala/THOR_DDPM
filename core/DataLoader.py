...
class DefaultDataLoader(pl.LightningDataModule):
    ...
    def __init__(self, args):
        ...
        if 'label_dir' in akeys:
            if 'train' not in self.label_dir.keys():
                self.label_dir['train'] = None
            if 'val' not in self.label_dir.keys():
                self.label_dir['val'] = None
            if 'test' not in self.label_dir.keys():
                self.label_dir['test'] = None
