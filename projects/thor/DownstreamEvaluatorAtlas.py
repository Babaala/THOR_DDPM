...
class PDownstreamEvaluator(DownstreamEvaluator):
    ...
    def start_task(self, global_model, noise_level=250):
        """
        ...
        self.pathology_localization(global_model, 3, 71, True, noise_level=noise_level)
        self.pathology_localization(global_model, 71, 570, True, noise_level=noise_level)
        self.pathology_localization(global_model, 570, 10000, True, noise_level=noise_level)
    

    def _log_visualization(self, to_visualize, i, count, save_path=None):
        """
    ...
    def pathology_localization(self, global_model, threshold_low, threshold_high, perc_flag=False, noise_level=250):
        """
        Validation of downstream tasks
        Logs results to wandb
        ...
        for dataset_key in self.test_data_dict.keys():
            ...
            for idx, data in tqdm(enumerate(dataset)):
                ...
                save_path = '/home/tanzl/code/githubdemo/THOR_DDPM/model_design/thor/temp_thor_detect_noise_{}/'.format(noise_level)
                if not os.path.exists(save_path):
                    os.makedirs(save_path)
                self._log_visualization(to_visualize, 0, idx, save_path=save_path+str(idx)+'.png')
